package com.ecommerce.my_shop.service.implementation;
...
import com.ecommerce.my_shop.dao.CustomerDao;
import com.ecommerce.my_shop.dao.ItemDao;
import com.ecommerce.my_shop.dao.ProductDao;
import com.ecommerce.my_shop.dao.ShoppingOrderDao;
import com.ecommerce.my_shop.dto.Cart;
...
import com.ecommerce.my_shop.helper.AES;
import com.ecommerce.my_shop.helper.MailSendingHelper;
import com.ecommerce.my_shop.service.CustomerService;
	...
	public String paymentPage(HttpSession session, ModelMap map, HttpServletResponse response) throws IOException {
		...
		if (customer == null) {
			...
			if (items.isEmpty()) {
				...
				try {
//				
				    RazorpayClient razorpay = new RazorpayClient("rzp_test_CtRZl541z9QUSi", "2eSsxZMdqflVuntwnRIRIhdt");
				    ...
				    // Create and populate ShoppingOrder object
				    ...
				    map.put("key", "rzp_test_CtRZl541z9QUSi");
				    ...
				    // Update session with the latest customer object
				    session.setAttribute("customer", customerDao.findById(customer.getId()));
				    ...
				    // Log the exception and redirect to the home page
				    e.printStackTrace();
				    response.sendRedirect("/");
				    return null;
				}
